...
export default function Trainer({ text, timeLimit, demo }: TrainerProps) {
  ...
  const isChallenge = usePathname().includes("challenge");
  const isEasyChallenge = usePathname().includes("easy");
  const isDifficultChallenge = usePathname().includes("difficult");
  const isNormalChallenge = usePathname().includes("normal");
  const isImpossibleChallenge = usePathname().includes("impossible");
  ...
  } else if (isChallenge && isImpossibleChallenge)
