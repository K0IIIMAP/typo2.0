...
const introText =
  "Welcome to Space Typo! Created by Kirill Amirov, a full-stack Next.js developer from Ukraine, this app is designed to enhance your typing skills. There are modes and challenges. Each challenge unlocks only after you successfully complete the previous one. Create an account to start!";
