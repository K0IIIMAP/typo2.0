...
export default function SignUpForm({
  ...
  const [signUpError, dispatchSignUp] = useFormState(createUser, undefined);
  return (
    <div
      className={cn(
    ...
    >
      ...
      <form className="text-white/80" onSubmit={handleSubmit(onSubmit)}>
        <input
          type="email"
        ...
        <button
          ...
          className="disabled:bg-accent/50 w-full p-3 bg-accent/100 text-white/80 rounded-md hover:bg-accent hover:scale-[1.01] focus:scale-[0.98] transition"
        >
          Sign Up
        </button>
      </form>
