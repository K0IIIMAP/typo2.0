...
const introText =
  "Welcome to Space Typo! Created by Kirill Amirov, a full-stack Next.js developer from Ukraine, this app is designed to enhance your typing skills. There are modes and challenges. Create an account to check them out. ";
