...
export default function SignUpForm({
  ...
  return (
    ...
    >
      ...
      <form className="text-white/80" action={() => dispatchCreateUser(data)}>
        <input
          type="email"
        ...
        <Button
          type="submit"
          disabled={pending}
          className="  mt-4 w-full p-3 bg-accent/100 text-white/80 rounded-md hover:bg-accent hover:scale-[1.01]  transition"
        >
          Sign Up
        </Button>
      </form>
